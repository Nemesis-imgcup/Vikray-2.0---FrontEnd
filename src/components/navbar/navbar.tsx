      ...
      <nav className="w-full bg-transparent shadow">
        <div className=" justify-between px-4 mx-auto lg:max-w-[90vw] md:items-center md:flex md:px-8">
          ...
          <div>
            ...
            >
              <div className="items-center justify-center backdrop-blur-xl space-y-8 md:flex md:space-x-[4vw] md:space-y-0">
                ...
                <div className="text-white font-medium hover:text-[#FFFF6D]">
                  <a href="javascript:void(0)">Customise</a>
                </div>
                <div className="text-white font-medium hover:text-[#FFFF6D]">
          ...
          <div
            className={`flex space-x-10 justify-self-center backdrop-blur-xl pb-3 mt-8 md:block md:pb-0 md:mt-0 ${
              navbar ? "block" : "hidden"
            }`}
          >
